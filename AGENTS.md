...
./gzstd-test.sh ./build/gzstd      # THE NORMAL RUN  (expect 438/0 on a GPU+GDS host)
./gzstd-test.sh ./build-cpu/gzstd  # CPU-only        (expect 342/0)
./gzstd-test.sh -e ./build/gzstd   # opt-in          (expect 569/0)
```
