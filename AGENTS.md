...
./gzstd-test.sh ./build/gzstd      # THE NORMAL RUN  (expect 466/0/1 of 467 on the 8-GPU GDS host)
./gzstd-test.sh ./build-cpu/gzstd  # CPU-only        (expect 349/0)
./gzstd-test.sh -e ./build/gzstd   # opt-in          (expect 598/0, derived)
```
