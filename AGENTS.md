...
./gzstd-test.sh ./build/gzstd      # THE NORMAL RUN  (expect 468/0/1 of 469 on the 8-GPU GDS host)
./gzstd-test.sh ./build-cpu/gzstd  # CPU-only        (expect 351/0)
./gzstd-test.sh -e ./build/gzstd   # opt-in          (expect 600/0, derived)
```
